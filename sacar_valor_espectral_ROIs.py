...
plt.savefig("C:/Users/nacho/OneDrive - Universidad de Alcala/TFM/OneDrive_1_23-5-2024 (1)/BA_2022_NN/figura1.png")

print("El gráfico de la respuesta espectral se ha guardado como figura1.png.")
