...
with fiona.open(shapefile_path, "r") as shapefile:
    ...
    with rasterio.open("C:/Users/nacho/OneDrive - Universidad de Alcala/TFM/resultados/imagen_recortada_0.tif", "w", **out_meta) as dest:
        dest.write(out_image)

    image_path2 = "C:/Users/nacho/OneDrive - Universidad de Alcala/TFM/resultados/imagen_recortada_0.tif"
    ...
    plt.savefig("C:/Users/nacho/OneDrive - Universidad de Alcala/TFM/resultados/respuesta_espectral_0.png")
    plt.close()
    print("El gráfico de la respuesta espectral se ha guardado en resultados como respuesta_espectral_0.png")
