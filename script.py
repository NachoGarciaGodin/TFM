...
for i in range (1,8):
    image_path = f"C:/Users/nacho/OneDrive - Universidad de Alcala/TFM/imagenes/image_25830.tif"
    ...
    with rasterio.open(f"C:/Users/nacho/OneDrive - Universidad de Alcala/TFM/resultados/imagen_recortada{i}.tif", "w", **out_meta) as dest:
        dest.write(out_image)

    image_path2 = f"C:/Users/nacho/OneDrive - Universidad de Alcala/TFM/resultados/imagen_recortada{i}.tif"
    ...
    plt.savefig(f"C:/Users/nacho/OneDrive - Universidad de Alcala/TFM/resultados/respuesta_espectral{i}.png")
    plt.close()
    print(f"El gráfico de la respuesta espectral se ha guardado en resultados como respuesta_espectral{i}.png")
